...
public class FileStorageService(IOptions<TimeWebSettings> options) : IFileStorageService
{
    private readonly string serviceURL = options.Value.ServiceURL;
    private readonly string region = options.Value.Region;
    private readonly string accessKey = options.Value.AccessKey;
